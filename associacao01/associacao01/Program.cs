...
namespace associacao01
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            PessoaFisica pessoaFisica = new PessoaFisica("Guilherme", "190", new Endereco("Precide Scarpino", "Rua", "Araraquara", "São Paulo", "Jd Santa Clara", 14811380, 126, "Fatec Araraquara"), 29, "12345678901");
            Console.WriteLine();
